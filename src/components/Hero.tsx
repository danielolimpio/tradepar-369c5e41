      ...
      <div className="container mx-auto px-4 relative z-10 pt-20 pb-16">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button size="lg" className="w-full sm:w-auto glow-bull group">
              Explorar Corretoras
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-12">
            <div className="bg-card/40 backdrop-blur-sm rounded-lg p-6 border border-border/50 hover-lift">
              <div className="flex items-center justify-center gap-2 mb-2">
                <TrendingUp className="h-5 w-5 text-primary" />
                <span className="text-3xl font-bold text-gradient-bull">50+</span>
              </div>
              <p className="text-sm text-muted-foreground">Corretoras Analisadas</p>
            </div>
            <div className="bg-card/40 backdrop-blur-sm rounded-lg p-6 border border-border/50 hover-lift">
              <div className="flex items-center justify-center gap-2 mb-2">
                <Zap className="h-5 w-5 text-destructive" />
                <span className="text-3xl font-bold text-gradient-bear">100+</span>
              </div>
              <p className="text-sm text-muted-foreground">Estratégias Testadas</p>
            </div>
            <div className="bg-card/40 backdrop-blur-sm rounded-lg p-6 border border-border/50 hover-lift">
              <div className="flex items-center justify-center gap-2 mb-2">
